...
function Perfil() {
    ...
    function handleUpdate(updateName, file) {
        if (updateName == '') {
            alert('O nome tem que ter no minímo 6 caracteres');
        }
    ...
    return (
        <div className='perfil'>
            <div className='container-perfil'>
                <h2>Avatar</h2>
                <div className='image'><img src={avatar} alt="avatar" /></div>
                <h3>Nome: </h3>
            ...
            <div className={modal ? 'modal-perfil' : 'off-modal-perfil'}>
                ...
                <div className='container-modal-perfil'>
                    ...
                    <h3>Avatar:</h3>
                    <img src={!preview ? avatar : preview} alt="avatar" />
            ...
            <div className={change ? 'modal-reload' : 'off-modal-reload'}>
                <div className='container-modal-reload'>
                    <div className={count > 7 ? 'off-container-count' : 'container-count'}>
                        <h3>Fazendo as alterações aguarde...</h3>
                        <div className='circle'></div>
                        <h4>{count}</h4>
                    </div>

                    <div className={count > 7 ? 'reload-sucess' : 'off-reload-sucess'}>
